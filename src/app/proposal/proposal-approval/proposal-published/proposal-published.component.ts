...
const swal = Swal;
@Component({
  selector: 'app-proposal-published',
  templateUrl: './proposal-published.component.html',
  styleUrls: ['./proposal-published.component.scss']
})
export class ProposalPublishedComponent implements OnInit {
