...
const swal = Swal;
@Component({
  selector: 'app-proposal-with-issues',
  templateUrl: './proposal-with-issues.component.html',
  styleUrls: ['./proposal-with-issues.component.scss']
})
export class ProposalWithIssuesComponent implements OnInit {
