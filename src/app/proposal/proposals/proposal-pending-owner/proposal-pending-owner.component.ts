...
const swal = Swal;
@Component({
  selector: 'app-proposal-pending-owner',
  templateUrl: './proposal-pending-owner.component.html',
  styleUrls: ['./proposal-pending-owner.component.scss']
})
export class ProposalPendingOwnerComponent implements OnInit {
